...
var p =  {
    ...
    angle  : 90,  speed: 4,
    health : 100, healthMax : 100, healthRegen :5,
    stamina: 100, staminaMax: 100, staminaRegen:5,
    defense: 1,
...
var g = {
    ...
    money    : 250, // money the player has
    gems     : 150,     // gems the player has
    wave     : 0,     // what wave the player is on
    waveTimer: 10,     // delay between waves
...
wep = [
...

    {
        ...
        Typ:"Lazer", frM:"auto",
        dam: 100, acc: -9999999, rcl: 0.08, stb: 0.003,
        spd: 25,prc: 3  ,
        mag: 5000000000, frt: 10 ,
        bpS: 25 ,rSp: 0,
        wgh: 0 ,
        dis: function(){
           fill(90, 218, 250);
    ...
    },
    {
        nam:"The Dragon",FlT:"",
        Typ:"sniper", frM:"auto",
        dam: 99, acc: 0.9, rcl: 0.15, stb: 0.003,
        spd: 35, prc: 10  ,
        mag: 20, frt: 40 ,
        bpS: 1 , rSp: 100 ,
        wgh: 3 ,
...

    {
        ...
        nam:"P23-Lion",FlT:"",
        Typ:"heavy", frM:"auto",
        dam: 25, acc: 0.4, rcl: 0.025, stb: 0.003,
        spd: 30, prc: 1  ,
        mag: 100,frt: 7 ,
        bpS: 1 , rSp: 200 ,
        wgh: 3 ,
    ...
    },
    {
        ...
        Typ:"rocket", frM:"auto",
        dam: 54.5, acc: 0., rcl: -0.01, stb: 0.005,
        spd: 30, prc: 1  ,
        mag: 9999,frt: 34 ,
        bpS: 4 , rSp: 0 ,
        wgh: 3.5 ,
...

    {
        ...
        Typ:"rocket", frM:"auto",
        dam: 50, acc: 0., rcl: 0.08, stb: 0.003,
        spd: 30, prc: 1  ,
        mag: 99999999,  frt: 20 ,
        bpS: 4 , rSp: 50,
        wgh: 0 ,
    ...
    },
    {
        ...
        Typ:"aimbot", frM:"auto",
        dam: 500, acc: -99999999, rcl: 0.00, stb: 0.003,
        spd: 35, prc: 0.1,
        mag: 9999999999999999999999999999999, frt: 5 ,
        bpS: 100 , rSp: 0,
        wgh: 0 ,
        dis: function(){
            fill(87,86,87);
...

    {
        ...
        Typ:"Lazer", frM:"auto",
        dam: 20, acc: -100.0, rcl: 0.0, stb: 0.0,
        spd: 10,prc: 0.1,
        mag: 100000000000000000,
			 frt: 1,
        bpS: 50 ,rSp: 80,
        wgh: 0 ,
        dis: function(){
