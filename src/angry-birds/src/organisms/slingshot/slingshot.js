import { Elastic_LEFT_X, Elastic_RIGHT_X, Elastic_Y, SLIGSHOT_BODY_X, SLIGSHOT_BODY_Y } from '../../atoms/constants';
...
class Slingshot extends Body {
  constructor(bird) {
    ...
    this.slingshotBody.body.render.sprite.texture =
      'https://raw.githubusercontent.com/yumin-jung/Angry-Birds/main/data/img/slingshot.png';
