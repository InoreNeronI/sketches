...
/**
 * The test implementation of the Level class
...
class TestLevel extends Level {
  ...
  TestLevel(float w, float h, int x_repeat, int y_repeat)
  {
    ...
    textFont(createFont("../assets/mario/fonts/acmesa.ttf",62));
    setBackground();
    addGround();
    addBushes();
    addCloudPlatforms();
  ...
  void setBackground() {
    ...
    Sprite bgsprite = new Sprite("../assets/mario/graphics/backgrounds/sky.gif");
    ...
    SoundManager.load(this, "../assets/mario/audio/bg/Overworld.mp3");
  ...
  void addGround() {
    ...
    // top of the ground
    Sprite groundsprite = new Sprite("../assets/mario/graphics/backgrounds/ground-top.gif");
    ...
    // ground filler
    TilingSprite groundfiller = new TilingSprite(new Sprite("../assets/mario/graphics/backgrounds/ground-filler.gif"), 0, height-40 + groundsprite.height, this.width+groundsprite.width, height);
  ...
  void addSlant(float x, float y) {
    Sprite groundslant = new Sprite("../assets/mario/graphics/backgrounds/ground-slant.gif");
  ...
  void addGroundPlatform(float x, float y, float w, float h) {
    // top layer
    Sprite lc = new Sprite("../assets/mario/graphics/backgrounds/ground-corner-left.gif");
    Sprite tp = new Sprite("../assets/mario/graphics/backgrounds/ground-top.gif");
    Sprite rc = new Sprite("../assets/mario/graphics/backgrounds/ground-corner-right.gif");
    lc.setPosition(x,y);
    ...
    // sides/filler
    Sprite ls = new Sprite("../assets/mario/graphics/backgrounds/ground-side-left.gif");
    Sprite rs = new Sprite("../assets/mario/graphics/backgrounds/ground-side-right.gif");
    Sprite fl = new Sprite("../assets/mario/graphics/backgrounds/ground-filler.gif");
  ...
  void addBushes() {
    ...
    for(int i=0, xpos=0, end=bush.length; i<end; i++) {
      Sprite sprite = new Sprite("../assets/mario/graphics/backgrounds/bush-0"+bush[i]+".gif");
      xpos += sprite.width;
  ...
  void addGoal() {
    int xpos = 1850;
    // background post
    Sprite goal_b = new Sprite("../assets/mario/graphics/assorted/Goal-back.gif");
    goal_b.align(CENTER,BOTTOM);
    goal_b.setPosition(xpos,height-47);
    addStaticSpriteBG(goal_b);
    // foreground post
    Sprite goal_f = new Sprite("../assets/mario/graphics/assorted/Goal-front.gif");
...
class Mario extends Player {
  ...
  void setupStates(String sizeSet) {
    ...
    // when not moving
    State standing = new State("standing","../assets/mario/graphics/mario/"+sizeSet+"/Standing-mario.gif");
    standing.sprite.align(CENTER, BOTTOM);
    addState(standing);

    // when either running right or left
    State running = new State("running","../assets/mario/graphics/mario/"+sizeSet+"/Running-mario.gif",1,4);
    running.sprite.align(CENTER, BOTTOM);
    running.sprite.setAnimationSpeed(0.75);
    addState(running);

    // when [down] is pressed
    State crouching = new State("crouching","../assets/mario/graphics/mario/"+sizeSet+"/Crouching-mario.gif");
    crouching.sprite.align(CENTER, BOTTOM);
    addState(crouching);

    // when [up] is pressed
    State looking = new State("looking","../assets/mario/graphics/mario/"+sizeSet+"/Looking-mario.gif");
    looking.sprite.align(CENTER, BOTTOM);
    addState(looking);

    // when pressing the A (jump) button
    State jumping = new State("jumping","../assets/mario/graphics/mario/"+sizeSet+"/Jumping-mario.gif");
    jumping.sprite.align(CENTER, BOTTOM);
    jumping.sprite.addPathLine(0,0,1,1,0,  0,0,1,1,0,  24);
    SoundManager.load(jumping, "../assets/mario/audio/Jump.mp3");
    addState(jumping);

    // when pressing the A button while crouching
    State crouchjumping = new State("crouchjumping","../assets/mario/graphics/mario/"+sizeSet+"/Crouching-mario.gif");
    crouchjumping.sprite.align(CENTER, BOTTOM);
    crouchjumping.sprite.addPathLine(0,0,1,1,0,  0,0,1,1,0,  24);
    SoundManager.load(crouchjumping, "../assets/mario/audio/Jump.mp3");
    addState(crouchjumping);

    // when pressing the B (shoot) button
    State spinning = new State("spinning","../assets/mario/graphics/mario/"+sizeSet+"/Spinning-mario.gif",1,4);
    spinning.sprite.align(CENTER, BOTTOM);
    spinning.sprite.addPathLine(0,0,1,1,0,  0,0,1,1,0,  24);
    SoundManager.load(spinning, "../assets/mario/audio/Spin jump.mp3");
    addState(spinning);

    // if we mess up, and we're small, we lose...
    if(sizeSet=="small") {
      State dead = new State("dead","../assets/mario/graphics/mario/"+sizeSet+"/Dead-mario.gif",1,2);
      ...
      dead.sprite.addPathCurve(0,0,1,1,0,
                               ...
                               0,250,
                               0,1200,1,1,0,  72,1);
      SoundManager.load(dead, "../assets/mario/audio/Dead mario.mp3");
      addState(dead); }
...
class Koopa extends Interactor {
  ...
  void setupStates() {
    // when walking around
    State walking = new State("walking","../assets/mario/graphics/enemies/Red-koopa-walking.gif",1,2);
    walking.sprite.align(CENTER, BOTTOM);
    walking.sprite.setAnimationSpeed(0.25);
    addState(walking);

    // when just standing, doing nothing
    State standing = new State("standing","../assets/mario/graphics/enemies/Red-koopa-standing.gif",1,2);
    standing.sprite.align(CENTER, BOTTOM);
    addState(standing);

    // if we get squished, we first get naked...
    State naked = new State("naked","../assets/mario/graphics/enemies/Naked-koopa-walking.gif",1,2);
    naked.sprite.setAnimationSpeed(0.25);
    naked.sprite.align(CENTER, BOTTOM);
    SoundManager.load(naked, "../assets/mario/audio/Squish.mp3");
    addState(naked);

    // if we get squished again, we die!
    State dead = new State("dead","../assets/mario/graphics/enemies/Dead-koopa.gif");
    dead.sprite.align(CENTER, BOTTOM);
    dead.sprite.addPathLine(0,0,1,1,0,  0,0,1,1,0,  12);
    dead.sprite.setLooping(false);
    SoundManager.load(dead, "../assets/mario/audio/Squish.mp3");
    addState(dead);
...
class FlyingKoopa extends Koopa {
  ...
  void setupStates() {
    ...
    // when walking around
    State flying = new State("flying","../assets/mario/graphics/enemies/Red-koopa-flying.gif",1,2);
    ...
    flying.sprite.addPathLine(0,0,-1,1,0,
                              0,0,1,1,0,
                              5);
    SoundManager.load(flying, "../assets/mario/audio/Squish.mp3");
    addState(flying);
...
class BanzaiBill extends Interactor {
   ...
   */
  void setupStates() {
    State flying = new State("flying","../assets/mario/graphics/enemies/Banzai-bill.gif");
    flying.sprite.align(LEFT,BOTTOM);
    SoundManager.load(flying, "../assets/mario/audio/Banzai.mp3");
    addState(flying);
    setCurrentState("flying");
...
abstract class SpecialBlock extends BoundedInteractor {
   ...
   */
  void setupStates() {
    State hanging = new State("hanging","../assets/mario/graphics/assorted/Coin-block.gif",1,4);
    hanging.sprite.setAnimationSpeed(0.25);
    addState(hanging);

    State boing = new State("boing","../assets/mario/graphics/assorted/Coin-block.gif",1,4);
    ...
    boing.sprite.addPathLine(0,-12,1,1,0,
                             0,0,1,1,0,
                             2);
    SoundManager.load(boing, "../assets/mario/audio/Coin.mp3");
    addState(boing);

    State exhausted = new State("exhausted","../assets/mario/graphics/assorted/Coin-block-exhausted.gif",1,1);
    addState(exhausted);
...
class PassThroughBlock extends BoundedInteractor {
   ...
   */
  void setupStates() {
    State hanging = new State("hanging","../assets/mario/graphics/assorted/Block.gif");
    hanging.sprite.setAnimationSpeed(0.25);
    addState(hanging);

    State passthrough = new State("passthrough","../assets/mario/graphics/assorted/Passthrough-block.gif",1,4);
...
class Coin extends Pickup {
  Coin(float x, float y) {
    super("Regular coin", "../assets/mario/graphics/assorted/Regular-coin.gif", 1, 4, x, y, true);
    SoundManager.load(this, "../assets/mario/audio/Coin.mp3");
  }
...
class DragonCoin extends Pickup {
  DragonCoin(float x, float y) {
    super("Dragon coin", "../assets/mario/graphics/assorted/Dragon-coin.gif", 1, 10, x, y, true);
    SoundManager.load(this, "../assets/mario/audio/Dragon coin.mp3");
  }
  void pickedUp() { SoundManager.play(this); }
}
...
class Mushroom extends Pickup {
  Mushroom(float x, float y) {
    super("Mushroom", "../assets/mario/graphics/assorted/Mushroom.gif", 1, 1, x, y, false);
    ...
    SoundManager.load(this, "../assets/mario/audio/Powerup.mp3");
    persistent = false;
  }
  void pickedUp() { SoundManager.play(this); }
}
...
class Rope extends Pickup {
  Rope(float x, float y) {
    super("Finish line", "../assets/mario/graphics/assorted/Goal-slider.gif", 1, 1, x, y, true);
    ...
    SoundManager.load(this, "../assets/mario/audio/bg/Course-clear.mp3");
  }
