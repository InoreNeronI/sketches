...
function AudioPlayer(str) {
    ...
    if (document.createElement("audio").canPlayType) {
        ...
        if (canPlayOgg()) audio.src = str.substring(0, str.lastIndexOf(".")) + ".ogg";
        else if (canPlayMp3()) audio.src = str;
        loaded = true;
    }
    ...
    this.rewind = function() {
        if (!loaded || audio.readyState === 0) return;
...
//# sourceMappingURL=index.4d5fea7d.js.map
