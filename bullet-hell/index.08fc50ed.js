...
BULLET.bomb = {
    ...
    onHitBottom () {
        this.dead = true;
        emitBullets(this.pos.x, this.pos.y, 0, [
            -45,
            -90,
            -135
        ], 5, 5, BULLET.basic, this.fromPlayer);
...
BULLET.large = {
    ...
    onOldAge () {
        emitBullets(this.pos.x, this.pos.y, this.angle, [
            0,
            60,
            120,
            180,
...
BULLET.largeBomb = {
    ...
    onHitBottom () {
        ...
        emitBullets(this.pos.x, this.pos.y, 0, [
            ...
            -90,
            -135
        ], 3, 5, BULLET.bomb, this.fromPlayer);
...
BULLET.twoStage = {
    ...
    onOldAge () {
        emitBullets(this.pos.x, this.pos.y, this.angle, [
            ...
            210,
            300
        ], 3, 4, BULLET.needle, this.fromPlayer);
    }
};
BULLET.splitter = {
    // Display
    ...
    onOldAge () {
        emitBullets(this.pos.x, this.pos.y, this.angle, [
            ...
            0,
            30
        ], 3, 4, BULLET.basic, this.fromPlayer);
    }
};
BULLET.small = {
    // Physics
...
//# sourceMappingURL=index.08fc50ed.js.map
