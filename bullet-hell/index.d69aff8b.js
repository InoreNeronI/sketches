class Player extends Ship {
    ...
    controls() {
        ...
        if (keyIsDown(RIGHT_ARROW) || keyIsDown(68)) {
            if (keyIsDown(UP_ARROW) || keyIsDown(87)) this.vel = createVector(diag, -diag);
            else if (keyIsDown(DOWN_ARROW) || keyIsDown(83)) this.vel = createVector(diag, diag);
            else this.vel = createVector(this.speed, 0);
        } else if (keyIsDown(LEFT_ARROW) || keyIsDown(65)) {
            if (keyIsDown(UP_ARROW) || keyIsDown(87)) this.vel = createVector(-diag, -diag);
            else if (keyIsDown(DOWN_ARROW) || keyIsDown(83)) this.vel = createVector(-diag, diag);
            else this.vel = createVector(-this.speed, 0);
        } else if (keyIsDown(DOWN_ARROW) || keyIsDown(83)) this.vel = createVector(0, this.speed);
        else if (keyIsDown(UP_ARROW) || keyIsDown(87)) this.vel = createVector(0, -this.speed);
...
//# sourceMappingURL=index.d69aff8b.js.map
