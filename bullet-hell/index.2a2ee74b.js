class Emitter extends Entity {
    ...
    // Emit bullets
    emit() {
        if (this.rel) emitBullets(this.rel.pos.x + this.pos.x, this.rel.pos.y + this.pos.y, this.angle, this.angles, this.minSpeed, this.maxSpeed, this.bulletTemplate);
        else emitBullets(this.pos.x, this.pos.y, this.angle, this.angles, this.minSpeed, this.maxSpeed, this.bulletTemplate);
    }
    ...
    update() {
        super.update();
        if (this.spinReversal && abs(this.angVel + this.angAcc) * dt() >= this.maxAngVel) this.angAcc *= -1;
        this.angVel += this.angAcc * dt();
        this.angle += this.angVel * dt();
    }
}

//# sourceMappingURL=index.2a2ee74b.js.map
